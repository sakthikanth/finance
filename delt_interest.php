<?php
          ...
          if($t)
          {
                   $r= q("insert into  amount_status (date_entry,interest,fin_id,cust_id,remain_bal,loan_type,delt,my_date)values('$entry_date',$int_amt,$fin_id,$stl_id,$remain_bal,'STL',1,'$date')");
               if($r){
               ...
               q("insert into interest_income (fin_id,total_interest)values($fin_id,$total_interest)");
                    ...
                    $e=q("update loan_leagure_stl set next_int_date='$next_int_date',paid_status=2 where fin_id=$fin_id and stl_id=$stl_id");
                    if($e){
                        if($pend_month>0){
