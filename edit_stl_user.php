...
<html>
    ...
    for($n=0;$n<count($p_int);$n++){
        ...
        function delt_this_intrst(int_amt,log_id,int_month,comm_id){
            alert("If You Delete this interest you should also delete the asal record accordingly.Otherwise New Interest Amount Will be calculated for current Remaining balance...");
