...
$cur_ses_date=$_SESSION['show_date']; ?>
...
<nav class="navbar navbar-default titlebar_nav" role="navigation">
    ...
    <div class="navbar-header title_text_div" >
        ...
        <a href="home.php"> <img  src="icons_imgs/header_logo.jpg"  class="navbar-header"/></a>
        ...
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
                ...
                <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="day_book.php">Day Book</a></li>
                            <li><a href="add_investers.php">Investment</a></li>
                            <li><a href="interest_income.php">Interest</a></li>
                            <li><a href="tally.php">Tally</a></li>
                            <li id="backup_btn"><a href="#">Back UP</a></li>
                            <li><a href="commision.php">My</a></li>
