                ...
                if($cur_dates<$paid_asal_date){
                   ...
                   ?>
                    <div class="prof_info col-lg-6">
                        ...
                        <a href="edit_hp_user.php?hp_id=<?php echo $hp_id; ?>" style="text-decoration: none"><button>
...
<div class="form_container col-lg-12">
                     ...
                     <div class="person_det_cont col-lg-6">
                        ...
                        <div class="tot_det_holder">
                            <div class="single_inp_det col-lg-12">
                                  <div class="inp_disc">Name</div>
                                  <div class="input_con">
                                  <?php echo ucfirst($j_person_name); ?>
                                  </div>
                            </div>
                            <div class="single_inp_det col-lg-12">
                                  <div class="inp_disc">Age</div>
        ...
        <?php echo "<script>asal_amt_rate=".$asal_amount_rate.";rem_asal=".$psa.";hp_idss=".$hp_id.";due_pend_month=".($due_months-$due_paid_cnt).";int_rate=".$ci.";tot_interesst=".$ci.";intrest_rate=".$ci.";tot_asal_mnth=$due_months;</script>"; ?>
 ...
 $('#tot_due_topay').html($('#tot_amount').val());
     ...
     function pay_asal(){
         ...
         if(asal_mnth>0 && asal_mnth<=tot_asal_mnth){
