...
Calendar.setup = function(params) {
  ...
  param_default("adjToScroll", true);
  ...
  triggerEl["on" + params.eventName] = function() {
    ...
    if (mustCreate) {
      params.renderDiv ? cal.create(params.renderDiv, params.options) : cal.create();
    };
    cal.refresh();
    if (!params.position) cal.showAtElement(params.button || params.displayArea || params.inputField, params.align, params.renderDiv, params.adjToScroll);
