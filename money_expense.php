      ...
      $exp_word="Other";
            ...
            if(isset($_REQUEST['pers_nm']) && isset($_REQUEST['per_amt'])){
              ...
              $n=-1;
                          ...
                          $q6=q("select exp_amount as nm from extra_expense where fin_id=$fin_id and exp_type='$exp_tp' order by exp_id asc limit 10");
...
<html>
              ...
              <?php
                if($q2){
                    ...
                    <tr>
                        ...
                        <td>
                        <font title="Delete" style="cursor: pointer" onclick="delt_this_exp(<?php echo $exp_amt; ?>,<?php echo $exp_id; ?>);" color="crimson">X</font>
  ...
  <?php  echo "<script>tot_cnt=".$tc.";</script>"; ?>
    ...
    alert("Please fill in Required Fields");
        ...
        function delt_this_exp(exp_amt,exp_id){
            ...
            var urls="delt_expense.php";
             $.ajax({
              ...
              if(psr==='delt'){
                   ...
                   window.location.href='money_expense.php';
             }
