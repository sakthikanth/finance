...
$fin_id=$_SESSION['fin_id'];
   ...
   if($close_acc==1){
       q("select int_amount as pend_im from stl_interest_sts where fin_id=$fin_id and stl_id=$stl_id");
   ...
   $day_int_month=30*$next_mnth;
             ...
             $fin_day=  calc_next_date($day_int_month, $pre_day, $pre_mnth, $pre_tyear);
                ...
                if($int_date>=$cur_date){
                   ...
                   if($remb<=0){
                    q("update customers_stl set person_status=2 where fin_id=$fin_id and stl_id=$stl_id");
