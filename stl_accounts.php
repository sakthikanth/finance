  ...
  <?php include './header.php'; ?>
        <div class="container">
            ...
            <div class="PG_ttl col-lg-6">
                STL Asal Logs of <?php echo $fn;  ?> Finance
            </div>
                ...
                <div class="PG_ch_inner">
                    ...
                    <table class="table table-striped table-responsive">
                        ...
                        <tbody>
                            ...
                            if(isset($_REQUEST['pagi'])){
                                $pagi_word=" and s.log_id <=".$_REQUEST['pagi'].' ';
                            ...
                            q("select distinct s.asal_in as asal_in,s.asal_out as asal_out,s.outer_asal_amt as outer_asal_amt,s.date as date,s.stl_id as stl_id,s.log_id as log_id from stl_asal_logs as s inner join customers_stl as c where c.fin_id=$fin_id $pagi_word $cust_wrd  order by s.log_id desc limit 20");
                            ...
                            for($n=0;$n<count($asal_in);$n++){
                                ...
                                q("select name as p_name from customers_stl where fin_id=$fin_id and stl_id=$p_stl_id");
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="view_stl_user.php?stl_id=<?php echo $p_stl_id; ?>">
                                        <button>
                                        View
                                    </button>
                                    </a>
                    ...
                    <div class="col-lg-12 pagi_hold">
                        <ul class="pagination pagination-lg">
                            ...
                            q("select distinct s.asal_in as asal_in,s.asal_out as asal_out,s.outer_asal_amt as outer_asal_amt,s.date as date,s.stl_id as stl_id,s.log_id as log_id from stl_asal_logs as s inner join customers_stl as c where c.fin_id=$fin_id $cust_wrd  order by s.log_id desc");
                            ...
                            for($n=0;$n<count($asal_in);$n++){
                                ...
                                if($pagi_cnt==1){
                                   ...
                                   if($blocked==0  ) {
                                         $pg_cnt++;
                                         ?> <li <?php echo $act; ?> ><a id="page_<?php echo $pg_cnt; ?>" href="stl_accounts.php?pagi=<?php echo $log_id[$n]; ?>"><?php echo $pagi_num; ?></a></li><?php
        ...
        function sort_users(its_id){
            if(its_id==="all"){
                            urls='stl_accounts.php';
 
            }else{
                if(its_id==="gen"){
                    urls='stl_accounts.php?cust_id=0';
                }else{
                    
                      urls='stl_accounts.php?cust_id='+its_id;
                }
