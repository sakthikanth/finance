  ...
  <?php include './header.php'; ?>
        <div class="container">
            <?php 
                ...
                q("select stl_id from customers_stl where fin_id=$fin_id");
                $tot_user=  count($stl_id);
                ?>
            <div class="PG_ttl col-lg-12">
                
                
                STL Accounts of <?php echo $fn;  ?> Finance
            </div>
                    ...
                    <table class="table table-striped table-responsive">
                        ...
                        <tbody>
                            ...
                            if(isset($_REQUEST['pagi'])){
                                $pagi_word=" and stl_id <=".$_REQUEST['pagi'].' ';
                            ...
                            q("select name as p_name,stl_id as sid,loan_amount as la,reg_date from customers_stl where fin_id=$fin_id $pagi_word  order by stl_id desc limit 20");
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="view_stl_user.php?stl_id=<?php echo $stl_id; ?>">
                                        <button>
                                        View
                                    </button>
                                    </a>
        ...
        q("select name as p_name,stl_id as log_id,loan_amount as la,reg_date from customers_stl where fin_id=$fin_id  order by stl_id desc");
                            ...
                            for($n=0;$n<count($p_name);$n++){
                                ...
                                if($pagi_cnt==1){
                                   ...
                                   if($blocked==0  ) {
                                         $pg_cnt++;
                                         ?> <li <?php echo $act; ?> ><a id="page_<?php echo $pg_cnt; ?>" href="stl_customers.php?pagi=<?php echo $log_id[$n]; ?>"><?php echo $pagi_num; ?></a></li><?php
