                    ...
                    <table class="table table-striped table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    Rs. <?php echo  convert_rup_format($dbk_remain); ?> /-
                                </td>
                                <td>
                              ...
                              <th>
                                  <a href="print_tally.php?log_id=<?php echo $logs_id; ?>" style="text-decoration:none;color: navy !important;"><button style="border: 1px solid gray">Take Print Page </button></a>
                              </th>
                              <th>
                                  Rs. <?php 
                              ...
                              <th>
                                 Rs. <?php
                                  ...
                                  $tot_expnes=$dbk_remain+$hp_asal_out_amt+$stl_asal_out_amt+$offc_exp+$salry_exp+$room_r_exp+$adv_exp+$bnks_exp+$oter_exp;
