        ...
        <div class="container">
          <div class="col-lg-12 logs_top_holder">
            <div class="PG_ttl col-lg-6">
              ...
              <div>
                  <button onclick='print_pdf()'>Print as Pdf</button>
              </div>
            ...
            $p_arr=  array();
                ...
                $cust_wrd="";
                            ...
                            $r=q("select distinct hl.fin_id as fid,hl.next_due_date as nid,hl.due_paid_cnt as due_paid_cnt,hl.log_id as log_id,hl.hp_id as hid,hl.current_interest as current_interest,hl.asal_amount_rate as asal_amount_rate,hl.diff_amount as diff_amount from loan_leagure_hp as hl inner join customers_hp as c where hl.fin_id=$fin_id $pagi_word $cust_wrd and hl.hp_id=c.hp_id order by nid  limit 20");
                       ...
                       $all_pend_mnths="";
                        $tot_pend_array=array();
                            for($n=0;$n<count($nid);$n++){
                                ...
                                $h_ref="view_hp_user.php?hp_id=".$hp_id;
                ...
                <div class="PG_ch_inner">
                    ...
                    <?php
                           ...
                           $r=q("select distinct hl.next_due_date as nid,hl.log_id as log_id from loan_leagure_hp as hl inner join customers_hp as c where hl.fin_id=$fin_id $pagi_word $cust_wrd  and hl.hp_id=c.hp_id  order by nid desc ");
