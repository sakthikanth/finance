    ...
    <body >
                ...
                <div class="asal_container">
                    <div class="payment_items_cont" id="payment_asal_cont" style="display: none">
                        ...
                        <div class="item_inp_cont">
                            <font> Asal </font>  <input type="text" readonly placeholder="Enter Amount"  value="<?php echo $asal_amount_rate*$asal_pend_motth; ?>" id="asal_amount" />
                            <font>for</font> <input type="number"  min="1" max="<?php echo $tot_rem_month;?>"  max="<?php echo $int_pen_cnt;?>"   oninput="calc_asal_amnt()"  id="asal_month"   value="<?php echo $asal_pend_motth;?>"  /> <font>( months )</font>

                        </div>
                            <div class="item_inp_cont asal_month_val">
                                    
                                   <font> Interest </font>  <input type="text" readonly placeholder="Enter Amount"   value="<?php echo $ci*$asal_pend_motth; ?>" id="int_amount" />

                                   <font>for</font> <input type="number"  min="1" max="<?php echo $tot_rem_month;?>"  max="<?php echo $int_pen_cnt;?>" oninput="calc_int_amnt()"   oninput="calc_int_amnt()" id="int_month"   value="<?php echo $asal_pend_motth;?>"  /> <font>( months )</font>
                        ...
                        <div class="item_submit_cont">
                            <button onclick="pay_asal()" id="sub_btns">Submit</button>
     ...
     function calc_int_amnt(){
       var int_month=$('#int_month').val()-1+1;
         ...
         if(int_month>due_pend_month){
             document.getElementById("sub_btns").disabled=true;
         }
